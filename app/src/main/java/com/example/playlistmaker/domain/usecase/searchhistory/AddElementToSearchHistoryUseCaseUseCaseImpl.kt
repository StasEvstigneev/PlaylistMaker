...
class AddElementToSearchHistoryUseCaseUseCaseImpl(private val searchHistoryRepository: SearchHistoryRepository, private val getSearchHistoryUseCase: GetSearchHistoryUseCase, private val gsonJsonConverter: GsonJsonConverter):
