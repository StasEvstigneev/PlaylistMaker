...
class SelectTrackForPlayerUseCase(private val searchHistoryRepository: SearchHistoryRepository, private val gsonJsonConverter: GsonJsonConverter):
    SelectTrackForPlayer {
